...
namespace common\components\alipay\directPay\lib;

use common\components\alipay\directPay\lib\Core;
...
class AlipayNotify {
	...
	function getSignVeryfy($para_temp, $sign) {
		...
		switch (strtoupper(trim($this->alipay_config['sign_type']))) {
			case "MD5" :
				$isSgin = Core::md5Verify($prestr, $sign, $this->alipay_config['key']);
				break;
			default :
				$isSgin = false;
		}
