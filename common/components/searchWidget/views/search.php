<?php
use common\components\searchWidget\SearchAsset;
SearchAsset::register($this);

?>
<div class="row"">
    <div class="<?='col-lg-'.$model->searchBoxLength?>" style="float: <?=$model->float?>">
        <span id="base_url" data="<?= $model->url;?>"></span>
        <span id="search_name" data="<?=$model->searchModelName;?>"></span>
            ...
            <div class="input-group-btn">
                <button type="button" class="btn <?= $model->searchColor?> dropdown-toggle" data-toggle="dropdown">
                    ...
                    <?php if (isset($model->searchAttribute)) {
                        ...
                        if (isset($attributeList[$model->searchAttribute]) && $attributeList[$model->searchAttribute]) {
...
$this->registerJs('
    $(function () {
        ...
        $("#search_button").click(function(){
            var baseUrl = $("#base_url").attr("data");
