...
class AppWechat extends Model
{
    ...
    const LOGIN_API = 'https://open.weixin.qq.com/connect/qrconnect?appid=%s&redirect_uri=%s&response_type=code&scope=%s&state=%s';
    const USER_INFO_API = 'https://api.weixin.qq.com/sns/userinfo?access_token=%s&openid=%s';
