...
<body onload="time_fun()" style="background:#FF7575">
	...
	<div class="container">
		<marquee direction="up" behavior="scroll" scrollamount="1" scrolldelay="0" loop="-1" width=100% height="40" bgcolor="#CE0000" vspace="10">
				...
				<div class="col-md-3 span_6">
				  <div class="box_inner">
					...
					<img src="<?=$baseUrl.$url?>" class="img-responsive" alt=""/>
					 ...
					 <div class="desc">
						<ul class="list2">
						  <li class="list2_right"><span class="m_1"><a href="<?=\yii\helpers\Url::to(['join/confirm', 'id' => $order->order_number])?>" class="link">立即提交</a></span></li>
